-- Generated by SQLazy's POSTGRES compiler from sqlazy/allocation.nspl.
-- Captured from https://www.sqlazy.com/ on 2026-08-25.
...
demand_resorted AS (
  SELECT
    ...
    SUM(
      CASE
        WHEN supply_type = 'PURCHASE_ORDER'
        AND available_date <= required_date THEN supply_qty
        ELSE NULL
      END
    ) AS cumulative_po,
    SUM(
      CASE
        WHEN supply_type = 'TRANSFER'
        AND available_date <= required_date THEN supply_qty
        ELSE NULL
      END
